...
(function (_$, undefined) {
    ...
    _$.fn.gantt = function (options) {
        ...
        var windowHeight = _$(document).height();
        /**
        ...
        */
        ...
        // can't use cookie if don't have `_$.cookie`
        settings.useCookie = settings.useCookie && _$.isFunction(_$.cookie);
     ...
     // Date prototype helpers
        ...
        var core = {
            ...
            elementFromPoint: (function(){ // IIFE
                ...
                return function (x, y) {
                    x -= _$(document).scrollLeft();
                    y -= _$(document).scrollTop();
                    return document.elementFromPoint(x, y);
                };
            })(),
            ...
            create: function (element) {
                ...
                if (typeof settings.source !== "string") {
                    ...
                    _$.getJSON(settings.source, function (jsData) {
                        element.data = jsData;
                        core.init(element);
                    });
                }
            ...
            init: function (element) {
				...
				if((Math.ceil(element.rowsNum / settings.itemsPerPage)-element.pageNum-1)<=0){
						_$(".gantt").animate({height:parseInt(element.rowsNum-element.pageNum*settings.itemsPerPage)*24+100},500);
				}else{
						_$(".gantt").animate({height:settings.itemsPerPage*24+100},500);
				}
            ...
            render: function (element) {
                var content = _$('<div class="fn-content"/>');
                ...
                element.gantt = _$('<div class="fn-gantt" />').append(content);

                _$(element).empty().append(element.gantt);
                ...
                if (settings.useCookie) {
                    var sc = _$.cookie(this.cookieKey + "ScrollPos");
                    if (sc) {
            ...
            leftPanel: function (element) {
                /* Left panel */
                var ganttLeftPanel = _$('<div class="leftPanel"/>')
                    .append(_$('<div class="row spacer"/>')
                    .css("height", tools.getCellSize() * element.headerRows + "px")
                    .css("width", "100%"));

                var entries = [];
                var temp_index = 1;//by szq  针对第一列没有name的现象
                _$.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                       var tempName = "";
                    	if(temp_index==1){//by szq
                    	   if(entry.name==""){
                    		   var temp = i;
                    		   while(temp>0){
                    			   if(element.data[temp].name!=""){
                    				   tempName = element.data[temp].name;
                    				   break;
                    			   }
                    			   temp--;
                    		   }
                       ...
                       temp_index +=1;
                        ...
                        entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + (tempName==""?entry.name:tempName) + '</span>');//by szq
                        entries.push('</div>');
            ...
            dataPanel: function (element, width) {
                var dataPanel = _$('<div class="dataPanel" style="width: ' + width + 'px;"/>');
                ...
                _$(element).on(wheel, function (e) { core.wheelScroll(element, e); });
                ...
                dataPanel.click(function (e) {
                    ...
                    var leftpanel = _$(element).find(".fn-gantt .leftPanel");
                    var datapanel = _$(element).find(".fn-gantt .dataPanel");
                    switch (settings.scale) {
                        case "weeks":
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                switch (settings.scale) {
                    ...
                    case "weeks":
                        ...
                        var day = range[0];
                        if(range[range.length-1].getFullYear()>year){
                        	range = range.del(range.length-1)
                        }
//alert(range.length);
...
//dataPanel.append(_$('<div class="toprow" style="margin-left: 0;" />').html(yearArr.join(""))+(monthArr.join(""))+(dayArr.join("")));
//dataPanel.append(_$('<div class="toprow" style="margin-left: 0; position: absolute;top: 0px;left: 0px; " />').html(yearArr.join("") + monthArr.join("") + dayArr.join("") + (dowArr.join(""))));
dataPanel.append(_$('<div class="toprow" style="margin-left: 0; position: absolute;top: 0px;left: 0px; " />').html(yearArr.join("") + monthArr.join("") + dayArr.join("") + (dowArr.join(""))));
                    ...
                    case 'months':
                        ...
                        dataPanel.append(_$('<div class="row"/>').html(dayArr.join("")));
                        dataPanel.append(_$('<div class="row"/>').html(dowArr.join("")));
                    ...
                    default:
                        ...
                        // Append panel elements
dataPanel.append(_$('<div class="toprow" style="margin-left: 0;" />').html(yearArr.join("")).append(monthArr.join("")).append(dayArr.join("")));

//.html(monthArr.join("")).html(dayArr.join("")).html(dowArr.join("")));
                     //   dataPanel.append(_$('<div class="row" style="margin-left: 0;" />').html(yearArr.join("")));
                     //   dataPanel.append(_$('<div class="row" style="margin-left: 0;" />').html(monthArr.join("")));
                     //   dataPanel.append(_$('<div class="row" style="margin-left: 0;" />').html(dayArr.join("")));
//alert(dataPanel.html);
                    //    dataPanel.append(_$('<div class="row" style="margin-left: 0;" />').html(dowArr.join("")));
                        break;
                }

                return _$('<div class="rightPanel"></div>').append(dataPanel);
            },
            ...
            navigation: function (element) {
                ...
                if (settings.navigate === "scroll") {
                    ganttNavigate = _$('<div class="navigate" />')
                        .append(_$('<div class="nav-slider" />')
                            .append(_$('<div class="nav-slider-left" />')
                                
                                /*.append(_$('<button type="button" class="nav-link nav-now"/>')
                                    .html('&#9679;')
                                    .click(function () {
                                        core.navigateTo(element, 'now');
                                    }))
                                .append(_$('<button type="button" class="nav-link nav-prev-week"/>')
                                    .html('&lt;&lt;')
                                    .click(function () {
                                ...
                                .append(_$('<button type="button" class="nav-link nav-prev-day"/>')
                                    .html('&lt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                            ...
                            .append(_$('<div class="nav-slider-content" />')
                                    .append(_$('<div class="nav-slider-bar" />')
                                            .append(_$('<a class="nav-slider-button" />')
                                                )
                            ...
                            .append(_$('<div class="nav-slider-right" />')
                                .append(_$('<button type="button" class="nav-link nav-next-day"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -4);
									...
									.append(_$('<button type="button" class="nav-link nav-page-back"/>')
                                    .html('&lt;')
                                    .click(function () {
                                        //core.navigatePage(element, -1);
                                    	prev_page();
                                    }))
                                .append(_$('<div class="page-number"/>')
                                        .append(_$('<span/>')
                                            .html( (nowpage +1) + ' of ' + element.pageCount)))
                                .append(_$('<button type="button" class="nav-link nav-page-next"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        //core.navigatePage(element, 1);
                                    	next_page(element.pageCount)
                                    }))
                                    //.append(_$("<button type='button' style='display:none' class='refresh_'/>").click(function(){ core.navigatePage(element, 0);}))
                            /*.append(_$('<button type="button" class="nav-link nav-next-week"/>')
                                    .html('&gt;&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -8);
                                ...
                                .append(_$('<button type="button" class="nav-link nav-zoomIn"/>')
                                    .html('&#43;')
                                    .click(function () {
                                        core.zoomInOut(element, -1);
                                    }))
                                .append(_$('<button type="button" class="nav-link nav-zoomOut"/>')
                                    .html('&#45;')
                                    .click(function () {
                                        core.zoomInOut(element, 1);
                                    }))*/
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = _$('<div class="navigate" />')
                       ...
                       .append(_$('<button type="button" class="nav-link nav-begin"/>')
                            .html('&#124;&lt;')
                            .click(function () {
                        ...
                        .append(_$('<button type="button" class="nav-link nav-end"/>')
                            .html('&gt;&#124;')
                            .click(function () {
                ...
                return _$('<div class="bottom"/>').append(ganttNavigate);
            },
            ...
            createProgressBar: function (days, cls, desc, label, dataObj) {
                ...
                var bar = _$('<div class="bar"><div class="fn-label">' + label + '</div></div>')
                        .addClass(cls)
                        .css({
                ...
                if (desc) {
                    bar
                      .mouseover(function (e) {
                          var hint = _$('<div class="fn-gantt-hint xxx" />').html(desc);
                          _$("body").append(hint);
                          var y_ = e.pageY;
                          var height_ = _$(hint).height();
                          if((y_+height_+15)>windowHeight)
                        	  y_ = y_-5-height_;
                      ...
                      .mouseout(function () {
                          _$(".fn-gantt-hint").remove();
                      })
                      .mousemove(function (e) {
                    	  var y_ = e.pageY;
                          var height_ = _$(".fn-gantt-hint").height();
                          if((y_+height_+15)>windowHeight)
                        	  y_ = y_-25-height_;
                          else
                        	  y_ +=15;
                          _$(".fn-gantt-hint").css("left", e.pageX);
                          _$(".fn-gantt-hint").css("top", y_);
                      });
                }
                bar.click(function (e) {
                    e.stopPropagation();
                    settings.onItemClick(_$(this).data("dataObj"));
                });
                return bar;
            },
            ...
            markNow: function (element) {
                switch (settings.scale) {
                    case "weeks":
                        ...
                        _$(element).find(':findweek("' + cd + '")').removeClass('wd').addClass('today');
                        break;
                    case "months":
                        _$(element).find(':findmonth("' + new Date().getTime() + '")').removeClass('wd').addClass('today');
                        break;
                    default:
                        var cd = Date.parse(new Date());
                        cd = (Math.floor(cd / 36400000) * 36400000);
                        _$(element).find(':findday("' + cd + '")').removeClass('wd').addClass('today');
                        break;
                }
            },
            ...
            fillData: function (element, datapanel, leftpanel /* <- never used? */) {
                ...
                _$.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        ...
                        _$.each(entry.values, function (j, day) {
                            var _bar = null;
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    // find row
                                    var topEl = _$(element).find("#rowheader" + i);
                                ...
                                case "weeks":
                                    ...
                                    var from = _$(element).find("#" + dtFrom.getWeekId());

                                    var cFrom = from.attr("offset");

                                    var to = _$(element).find("#" + dtTo.getWeekId());
                                    var cTo = to.attr("offset");
                                    ...
                                    var top = tools.getCellSize() * 2 + 2 + parseInt(topEl.attr("offset"), 10);//byb change 
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
                                ...
                                case "months":
                                    ...
                                    var from = _$(element).find("#dh-" + tools.genId(dtFrom.getTime()));
                                    var cFrom = from.attr("offset");
                                    var to = _$(element).find("#dh-" + tools.genId(dtTo.getTime()));
                                    var cTo = to.attr("offset");
                                    var dl = Math.round((cTo - cFrom) / tools.getCellSize()) + 1;
            ...
            navigateTo: function (element, val) {
                var $rightPanel = _$(element).find(".fn-gantt .rightPanel");
                var $dataPanel = $rightPanel.find(".dataPanel");
            ...
            navigatePage: function (element, val) {
                if ((element.pageNum + val) >= 0 && (element.pageNum + val) < Math.ceil(element.rowsNum / settings.itemsPerPage)) {
                    core.waitToggle(element, true, function () {
                        element.pageNum += val;
                        element.hPosition = _$(".fn-gantt .dataPanel").css("margin-left").replace("px", "");
                        element.scaleOldWidth = false;
                        
						//nowpage = element.pageNum;
...
headerRows = 3;
                    ...
                    if ((zoomIn && _$.inArray(scale, scales) < _$.inArray(settings.minScale, scales))
                        || (!zoomIn && _$.inArray(scale, scales) > _$.inArray(settings.maxScale, scales))) {
                        core.init(element);
                        return;
                    }
                    ...
                    if (settings.useCookie) {
                        _$.cookie(this.cookieKey + "CurrentScale", settings.scale);
                        // reset scrollPos
                        _$.cookie(this.cookieKey + "ScrollPos", null);
                    }
                    core.init(element);
                });
            },
            ...
            sliderScroll: function (element, e) {
                var $sliderBar = _$(element).find(".nav-slider-bar");
            ...
            scrollPanel: function (element, delta) {
                ...
                if (_panelMargin > 0) {
                    element.scrollNavigation.panelMargin = 0;
                    _$(element).find(".fn-gantt .dataPanel").css("margin-left", element.scrollNavigation.panelMargin + "px");
            ...
            repositionLabel: function (element) {
                setTimeout(function () {
                    var $dataPanel;
                    if (!element) {
                        $dataPanel = _$(".fn-gantt .rightPanel .dataPanel");
                    } else {
                        var $rightPanel = _$(element).find(".fn-gantt .rightPanel");
                    ...
                    if (settings.useCookie) {
                        _$.cookie(this.cookieKey + "ScrollPos", $dataPanel.css("margin-left").replace("px", ""));
                    }
                }, 500);
            },
            ...
            waitToggle: function (element, show, fn) {
                if (show) {
                    var eo = _$(element).offset();
                    var ew = _$(element).outerWidth();
                    var eh = _$(element).outerHeight();

                    if (!element.loader) {
                        element.loader = _$('<div class="fn-gantt-loader">'
                        + '<div class="fn-gantt-loader-spinner"><span>' + settings.waitText + '</span></div></div>');
                    }
                    _$(element).append(element.loader);
                    setTimeout(fn, 500);
        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                var maxDate = null;
                _$.each(element.data, function (i, entry) {
                    _$.each(entry.values, function (i, date) {
                        maxDate = maxDate < tools.dateDeserialize(date.to) ? tools.dateDeserialize(date.to) : maxDate;
                    });
                });
                var temp = document.getElementById("yearlic");//by szq
                var tempYear = "";
                if(temp!=null){
                	tempYear = parseInt(temp.innerHTML);
                }
                var tempDate_ = new Date(tempYear==""?new Date().getFullYear():tempYear,11,31);
                maxDate = maxDate<tempDate_?tempDate_:maxDate;
                //maxDate = maxDate || ;
                /*switch (settings.scale) {
                    case "hours":
                        maxDate.setHours(Math.ceil((maxDate.getHours()) / element.scaleStep) * element.scaleStep);
                        maxDate.setHours(maxDate.getHours() + element.scaleStep * 7);
                        break;
                    case "weeks":
                        var bd = new Date(maxDate.getTime());
                        var bd = new Date(bd.setDate(bd.getDate() + 4 * 7));
            ...
            getMinDate: function (element) {
                ...
                var tempDate_ = new Date(tempYear==""?new Date().getFullYear():tempYear,0,1);
                minDate = tempDate_//minDate > tempDate_?tempDate_:minDate;
                /*switch (settings.scale) { 
                    case "hours":
                        minDate.setHours(Math.floor((minDate.getHours()) / element.scaleStep) * element.scaleStep);
                        minDate.setHours(minDate.getHours() - element.scaleStep * 7);
                        break;
                    case "weeks":
                        ...
                        var md = Math.floor(bd.getDate() / 7) * 7;
//alert(md);
                        minDate = new Date(bd.getFullYear(), bd.getMonth(), md === 0 ? 1 : md - 3);
                        break;
                    case "months":
            ...
            dateDeserialize: function (date) {
                if (typeof date === "string") {
                    ...
                    date = _$.isNumeric(date) ? parseInt(date, 10) : _$.trim(date);
                }
            ...
            getCellSize: function () {
                if (!tools._getCellSize) {
                    _$("body").append(
                        _$('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="row"></div></div>')
                    );
                    tools._getCellSize = _$("#measureCellWidth .row").height();
                    _$("#measureCellWidth").empty().remove();
                }
            ...
            getRightPanelSize: function () {
                _$("body").append(
                    _$('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="rightPanel"></div></div>')
                );
                var ret = _$("#measureCellWidth .rightPanel").height();
                _$("#measureCellWidth").empty().remove();
                return ret;
            },
            ...
            getProgressBarMargin: function () {
                if (!tools._getProgressBarMargin && tools._getProgressBarMargin !== 0) {
                    _$("body").append(
                        _$('<div style="display: none; position: absolute;" id="measureBarWidth" ><div class="fn-gantt"><div class="rightPanel"><div class="dataPanel"><div class="row day"><div class="bar" /></div></div></div></div></div>')
                    );
                    tools._getProgressBarMargin = parseInt(_$("#measureBarWidth .fn-gantt .rightPanel .day .bar").css("margin-left").replace("px", ""), 10);
                    tools._getProgressBarMargin += parseInt(_$("#measureBarWidth .fn-gantt .rightPanel .day .bar").css("margin-right").replace("px", ""), 10);
                    _$("#measureBarWidth").empty().remove();
                }
        ...
        this.each(function () {
            ...
            if(settings.pageNum>0){
            	this.pageNum = settings.pageNum;
            	//nowpage = settings.pageNum;
            }else{
            	this.pageNum = 0;
            	//nowpage = 0;
            }
            ...
            if (settings.useCookie) {
                var sc = _$.cookie(this.cookieKey + "CurrentScale");
                if (sc) {
                    settings.scale = _$.cookie(this.cookieKey + "CurrentScale");
                } else {
                    _$.cookie(this.cookieKey + "CurrentScale", settings.scale);
                }
            }
            ...
            switch (settings.scale) {
                ...
                case "weeks": this.headerRows = 2; this.scaleStep = 13; break;//byb change
                case "months": this.headerRows = 2; this.scaleStep = 14; break;
//                default: this.headerRows = 4; this.scaleStep = 13; break;
 default: this.headerRows = 2; this.scaleStep = 13; break;
            }
