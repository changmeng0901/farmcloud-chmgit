...
var ScrollComment = (function (_super) {
    ...
    function ScrollComment(parent, data) {
        ...
        this.dur *= this.parent.options.scroll.scale*2;
        this.ttl *= this.parent.options.scroll.scale*2;
    }
...
var CommentManager = (function() {
	...
	CommentManager.prototype.clear = function(){
		...
		if(this.addline.length>0){
			for(var i = 0;i<this.addline.length ;i++){
				this.timeline.push(this.addline[i]);
			}
			this.addline = new Array();
			this.timeline.sort(function(a,b){
				if(a.stime > b.stime) return 2;
				else if(a.stime < b.stime) return -2;
				else{
